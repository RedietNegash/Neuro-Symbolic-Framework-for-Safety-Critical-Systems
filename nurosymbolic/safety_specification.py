...
def create_safety_specifications():
    ...
    uav_control_tasks = [
        TaskSpecification("AttitudeControl", priority=1, period=0.01, wcet=0.002, deadline=0.01),
        TaskSpecification("AltitudeControl", priority=2, period=0.02, wcet=0.003, deadline=0.02),
        TaskSpecification("NavigationUpdate", priority=3, period=0.05, wcet=0.004, deadline=0.05),
        TaskSpecification("Telemetry", priority=4, period=0.1, wcet=0.006, deadline=0.1),
    ]
